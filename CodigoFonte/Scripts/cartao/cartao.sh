...
# Inicio - Horácio - 01/07/2018
#convert -background '#ffffffff' -fill black -font VerdanaB -gravity center -pointsize 46 -size 1063 caption:"$site_mch/$nomeappstaxi" appstaxibr.png
#composite -geometry +0+510 appstaxibr.png "$pasta_mkt"/Cartao/cartao.png "$pasta_mkt"/Cartao/cartao.png
convert -background '#ffffffff' -fill black -font VerdanaB -gravity center -pointsize 46 -size 1063 caption:"$site_mch/$nomeappstaxi" "$pasta_origem"/appstaxibr-$nomeappstaxi.png

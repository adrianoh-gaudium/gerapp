...
convert -background '#f6ba17ff' -fill white -font verdana -gravity center -pointsize 72 -size 1221 caption:"apps.taxi.br/$nomeappstaxi" imagens/contact-{$nomecoop}.png

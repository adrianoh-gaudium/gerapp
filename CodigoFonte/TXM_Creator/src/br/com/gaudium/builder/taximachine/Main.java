...
public class Main {
	...
	private JRadioButton rbConfAPI, rbConfDadosD;
	private JTextField txtServidorConfAPI;
	private JTextField txtURLConfAPI;

	private	JPanel pnlAPIConf;
	...
	private void initialize() {
		...
		JLabel lblApiDeConfigurao = new JLabel("API de configuração");
		lblApiDeConfigurao.setOpaque(true);
		lblApiDeConfigurao.setFont(new Font("SansSerif", Font.BOLD, 12));
		lblApiDeConfigurao.setBounds(18, 562, 120, 14);
		tabConfig.add(lblApiDeConfigurao);

		JLabel lblContas = new JLabel("Contas e logins");
		lblContas.setBackground(SystemColor.window);
		lblContas.setOpaque(true);
		lblContas.setFont(new Font("SansSerif", Font.BOLD, 12));
		lblContas.setBounds(13, 510, 91, 14);
		tabConfig.add(lblContas);

		JLabel lblPinosDoMapa = new JLabel("Pinos do mapa");
		lblPinosDoMapa.setOpaque(true);
		lblPinosDoMapa.setFont(new Font("SansSerif", Font.BOLD, 12));
		lblPinosDoMapa.setBounds(18, 351, 86, 14);
		...
		lblServidorParaCadastrar.setFont(new Font("SansSerif", Font.BOLD, 12));
		lblServidorParaCadastrar.setBounds(18, 262, 163, 14);
		...
		lblSubdirectoryName.setFont(new Font("SansSerif", Font.BOLD, 12));
		lblSubdirectoryName.setBounds(18, 206, 235, 14);
		tabConfig.add(lblSubdirectoryName);

		JLabel lblFolders = new JLabel("Pastas");
		lblFolders.setOpaque(true);
		lblFolders.setFont(new Font("SansSerif", Font.BOLD, 12));
		...
		btnDadosApps.setIcon(new ImageIcon(Main.class.getResource("/resources/folder.png")));
		...
		txtDadosApps.setBounds(129, 15, 600, 24);
		...
		btnProjsAndamento.setIcon(new ImageIcon(Main.class.getResource("/resources/folder.png")));
		...
		txtProjsAndamento.setBounds(129, 40, 600, 24);
		...
		txtAndroidCustom.setBounds(129, 66, 600, 24);
		panel.add(txtAndroidCustom);

		JButton btnAndroidCustom = new JButton("");
		btnAndroidCustom.setBounds(727, 66, 35, 23);
		btnAndroidCustom.setIcon(new ImageIcon(Main.class.getResource("/resources/folder.png")));
		...
		txtArqBase.setBounds(129, 118, 600, 24);
		panel.add(txtArqBase);

		JButton btnIOSCustom = new JButton("");
		btnIOSCustom.setBounds(727, 92, 35, 23);
		btnIOSCustom.setIcon(new ImageIcon(Main.class.getResource("/resources/folder.png")));
		...
		btnArqsBase.setIcon(new ImageIcon(Main.class.getResource("/resources/folder.png")));
		...
		txtIOSCustom.setBounds(129, 92, 600, 24);
		...
		txtScriptPath.setBounds(129, 143, 600, 24);
		panel.add(txtScriptPath);

		JButton btnScripts = new JButton("");
		btnScripts.setIcon(new ImageIcon(Main.class.getResource("/resources/folder.png")));
		...
		txtSecretDir.setBounds(129, 168, 600, 24);
		panel.add(txtSecretDir);

		JButton btnSecret = new JButton("");
		btnSecret.setIcon(new ImageIcon(Main.class.getResource("/resources/folder.png")));
		...
		panel_11.setBounds(6, 210, 768, 61);
		...
		panel_4.setBounds(6, 270, 768, 91);
		...
		lblSenha.setBounds(514, 47, 42, 14);
		...
		panel_5.setBounds(6, 360, 768, 159);
		...
		panel_3.setBounds(6, 517, 768, 54);
		...
		JLabel lblFonteDosDados = new JLabel("Fonte dos dados");
		lblFonteDosDados.setFocusTraversalKeysEnabled(false);
		lblFonteDosDados.setFocusable(false);
		lblFonteDosDados.setOpaque(true);
		lblFonteDosDados.setFont(new Font("SansSerif", Font.PLAIN, 12));
		lblFonteDosDados.setBounds(295, 62, 95, 14);
		tabProjeto.add(lblFonteDosDados);
		...
		panel_7.setBounds(250, 69, 220, 39);
		panel_7.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null));
		tabProjeto.add(panel_7);

		rbConfAPI = new JRadioButton("API");
		rbConfAPI.setHorizontalAlignment(SwingConstants.LEFT);
		rbConfAPI.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				consistirTela();
			}
		});
		rbConfAPI.setSelected(true);
		panel_7.add(rbConfAPI);

		rbConfDadosD = new JRadioButton("Arquivo dados.d");
		rbConfDadosD.setHorizontalAlignment(SwingConstants.RIGHT);
		rbConfDadosD.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				consistirTela();
			}
		});
		rbConfDadosD.setSelected(true);
		panel_7.add(rbConfDadosD);

		ButtonGroup rbGroup = new ButtonGroup();
		rbGroup.add(rbConfAPI);
		rbGroup.add(rbConfDadosD);

		pnlAPIConf = new JPanel();
		pnlAPIConf.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null));
		pnlAPIConf.setBounds(6, 570, 768, 61);
		tabConfig.add(pnlAPIConf);
		pnlAPIConf.setLayout(null);
		
		JLabel lblServidor_1 = new JLabel("Servidor");
		lblServidor_1.setBounds(10, 22, 45, 16);
		lblServidor_1.setOpaque(true);
		lblServidor_1.setHorizontalAlignment(SwingConstants.RIGHT);
		lblServidor_1.setFont(new Font("SansSerif", Font.PLAIN, 12));
		pnlAPIConf.add(lblServidor_1);

		txtServidorConfAPI = new JTextField();
		txtServidorConfAPI.setBounds(60, 16, 368, 28);
		txtServidorConfAPI.setText((String) null);
		txtServidorConfAPI.setColumns(10);
		pnlAPIConf.add(txtServidorConfAPI);

		JLabel lblApi_1 = new JLabel("URL ");
		lblApi_1.setBounds(453, 22, 28, 16);
		lblApi_1.setOpaque(true);
		lblApi_1.setHorizontalAlignment(SwingConstants.LEFT);
		lblApi_1.setFont(new Font("SansSerif", Font.PLAIN, 12));
		pnlAPIConf.add(lblApi_1);

		txtURLConfAPI = new JTextField();
		txtURLConfAPI.setBounds(486, 16, 178, 28);
		txtURLConfAPI.setText((String) null);
		txtURLConfAPI.setColumns(10);
		pnlAPIConf.add(txtURLConfAPI);
		...
		btnPreparar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				data.setConfAPI(rbConfAPI.isSelected());
				
				data.setServidorConfAPI(txtServidorConfAPI.getText().trim());
				data.setUrlConfAPI(txtURLConfAPI.getText().trim());
	...
	protected void consistirTela() {
		txtServidorConfAPI.setEnabled(rbConfAPI.isSelected());
		txtURLConfAPI.setEnabled(rbConfAPI.isSelected());
	}
	...
	private void gravarDadosTela() {
		...
		try {
			...
			p.put(Util.RB_CONF_API, (data.isConfAPI()?"true":"false"));

			p.put(Util.URL_API_CONF_API, txtURLConfAPI.getText().trim());
			p.put(Util.SERVIDOR_CONF_API, txtServidorConfAPI.getText().trim());
	...
	private void buscarDadosTela() {
		...
		try {
			...
			if (Boolean.valueOf(p.getProperty(Util.RB_CONF_API, "false"))) {
				rbConfAPI.setSelected(true);
			} else { 
				rbConfDadosD.setSelected(true);
			}
			...
			chkMarketing.setSelected(Boolean.valueOf(p.getProperty(Util.CHK_MARKETING, "false")));
			chkPackage.setSelected(Boolean.valueOf(p.getProperty(Util.CHK_PACKAGE, "false")));
			chkMeta.setSelected(Boolean.valueOf(p.getProperty(Util.CHK_META, "false")));
			chkAndroid.setSelected(Boolean.valueOf(p.getProperty(Util.CHK_ANDROID, "false")));
			chkIOS.setSelected(Boolean.valueOf(p.getProperty(Util.CHK_IOS, "false")));

			txtURLConfAPI.setText(p.getProperty(Util.URL_API_CONF_API));
			txtServidorConfAPI.setText(p.getProperty(Util.SERVIDOR_CONF_API));
